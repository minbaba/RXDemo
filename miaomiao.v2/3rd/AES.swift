...
extension NSData {
    ...
    private func aesCBC(operation:CCOperation, key:String, iv:String? = nil) -> NSData? {
        ...
        var encrypt_bytes = [UInt8](count: input_bytes.count * 4, repeatedValue: 0)
        ...
        let status = CCCrypt(UInt32(operation), UInt32(kCCAlgorithmAES128), UInt32(kCCOptionPKCS7Padding),
                ...
                input_bytes, input_bytes.count, &encrypt_bytes, input_bytes.count * 4, &encrypt_length)
    ...
    public func aesCBCEncrypt(key:String,iv:String = "0312032293271340") -> NSData? {
        return aesCBC(UInt32(kCCEncrypt), key: key, iv: iv)
    }
    /// Decrypt data in CBC Mode ,iv will be filled with zero if not specificed
    public func aesCBCDecrypt(key:String,iv:String = "0312032293271340")->NSData?{
...
//        print(data!.hexString)
    ...
    public func aesCBCDecryptFromHex(key:String,iv:String = "0312032293271340") ->String?{
...
//        print(raw_data.hexString)
    ...
    public func aesCBCDecryptFromBase64(key:String, iv:String = "0312032293271340") ->String? {
